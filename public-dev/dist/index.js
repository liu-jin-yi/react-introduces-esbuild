...
function App() {
  ...
  }, /* @__PURE__ */ React.createElement("h1", null, "Destiny__"), /* @__PURE__ */ React.createElement(logo_default, {
    className: "App-logo"
...
var reportWebVitals = (onPerfEntry) => {
  if (onPerfEntry && onPerfEntry instanceof Function) {
    import("./chunks/web-vitals.6WZLTTPH.js").then(({ getCLS, getFID, getFCP, getLCP, getTTFB }) => {
      getCLS(onPerfEntry);
      getFID(onPerfEntry);
      getFCP(onPerfEntry);
      getLCP(onPerfEntry);
